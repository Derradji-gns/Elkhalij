...
export default function Nav() {
  ...
  return (
    <div className="bg-gray-100 font-sans w-full h-auto m-0">
      <div className="bg-white shadow">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            <div className='flex items-center gap-3'>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-green-700" viewBox="0 0 24 24">
          ...
          </svg><h2 className='text-green-700 font-extrabold'>ELKHALIJ SCHOOL</h2>
            </div>

            <div className="hidden sm:flex sm:items-center">
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mr-4">Menu</a>
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mr-4">Specializations</a>
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mr-4">Historic</a>
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700">About us</a>
            </div>

            <div className="hidden sm:flex sm:items-center">
              <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mr-4">Sign in</a>
              <a href="#" className="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg  hover:text-green-700">Sign up</a>
            </div>

            <div className="sm:hidden cursor-pointer" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
          ...
          {mobileMenuOpen && (
            <div className="sm:hidden bg-white border-t-2 py-2">
              <div className="flex flex-col">
                <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mb-1">Products</a>
                <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mb-1">Marketplace</a>
                <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mb-1">Partners</a>
                <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mb-1">Pricing</a>
                <div className="flex justify-between items-center border-t-2 pt-2">
                  <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-700 mr-4">Sign in</a>
                  <a href="#" className="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-green-700 hover:border-green-700">Sign up</a>
                </div>
              </div>
            </div>
          )}
