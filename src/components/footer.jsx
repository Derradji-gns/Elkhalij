export default function Footer()  {
  return (
    <div className="relative mt-16 bg-green-700 text-gray-400">
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 bg-green-700 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="text-sm text-gray-400 text-deep-purple-50">
